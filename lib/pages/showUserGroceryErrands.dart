...
class ShowUserGroceryErrands extends StatefulWidget{
  @override
  ShowUserGrocery createState() => ShowUserGrocery();
}

class ShowUserGrocery extends State<ShowUserGroceryErrands> {
  static const customColor = const Color(0xff151B54);
  final dbData =
  FirebaseFirestore.instance.collection("Grocery Orders").snapshots();
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Super Store", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Store'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Custom Store", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Custom Store'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      ...
                                      Expanded(
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                onPressed: (){
                                                  var item = FirebaseFirestore.instance.collection("Grocery Orders").doc(snapshot.data?.docs[index].id.toString());
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Super Store", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Store'])
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Custom Store", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Custom Store'])
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
