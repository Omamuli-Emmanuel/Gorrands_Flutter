...
class ShowUserFoodErrands extends StatefulWidget{
  @override
  ShowUserFood createState() => ShowUserFood();
}

class ShowUserFood extends State<ShowUserFoodErrands> {
  static const customColor = const Color(0xff151B54);
  final dbData =
  FirebaseFirestore.instance.collection("Food Orders").snapshots();
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Food Vendor", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Food Vendor'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Custom Vendor", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Custom Food Vendor'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Reciever's Name", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Reciever Name'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(height: 5.0),

                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Reciever's Phone", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500))
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      ...
                                      Expanded(
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                onPressed: (){
                                                  var item = FirebaseFirestore.instance.collection("Food Orders").doc(snapshot.data?.docs[index].id.toString());
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Food Vendor", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Food Vendor'])
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Custom Vendor", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Custom Food Vendor'])
                                  ),
                                  SizedBox(height: 5.0),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Reciever's Name", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
                                      child: Text(snapshot.data?.docs[index]['Reciever Name'])
                                  ),
                                  SizedBox(height: 5.0),

                                  SizedBox(
                                      width: double.infinity,
                                      child: Text("Reciever's Phone", style: TextStyle(fontFamily: "Raleway", fontWeight: FontWeight.w200),)
                                  ),
                                  SizedBox(
                                      width: double.infinity,
