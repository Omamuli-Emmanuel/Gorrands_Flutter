...
class Package extends StatefulWidget{
  @override
  HelloPackage createState() => HelloPackage();
}

class HelloPackage extends State<Package> {
  static const customColor = const Color(0xff151B54);
  final dbData = FirebaseFirestore.instance.collection("Package Orders").snapshots();
  final collection = FirebaseFirestore.instance.collection("Package Orders");
  String ErrandType = "";
  //snackbars
